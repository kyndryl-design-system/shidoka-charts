...
export const getColorPalette = (key) => {
  const palettes = {
    ...
    rag08: [
      '--kd-color-data-viz-rag-6-success',
      '--kd-color-data-viz-rag-6-success-light',
      '--kd-color-data-viz-rag-6-warning',
      '--kd-color-data-viz-rag-6-warning-light',
      '--kd-color-data-viz-rag-6-error',
      '--kd-color-data-viz-rag-6-error-light',
      '--kd-color-data-viz-rag-6-informational',
      '--kd-color-data-viz-rag-6-information-light',
    ],
  };
