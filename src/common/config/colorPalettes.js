...
export const getColorPalette = (key) => {
  const palettes = {
    ...
    rag03: [
      '--kd-color-data-viz-rag-success',
      '--kd-color-data-viz-rag-warning',
      '--kd-color-data-viz-rag-error',
    ],
    rag08: [
      '--kd-color-data-viz-rag-success',
      '--kd-color-data-viz-rag-success-light',
      '--kd-color-data-viz-rag-warning',
      '--kd-color-data-viz-rag-warning-light',
      '--kd-color-data-viz-rag-error',
      '--kd-color-data-viz-rag-error-light',
      '--kd-color-data-viz-rag-informational',
      '--kd-color-data-viz-rag-information-light',
    ],
  };
