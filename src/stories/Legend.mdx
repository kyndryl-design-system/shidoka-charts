...
Legends help users identify the data series displayed in a chart. The Shidoka Charts library offers several options for legends:
...
The chart component has a `use-html-legend` attribute that controls which built-in legend to use.
