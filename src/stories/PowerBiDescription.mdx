...
Create a framework that leverages Shidoka's existing color token system and applies it in a format and structure that Power BI expects, understands, and is apply it in JSON format as multiple custom theme files.

### Implementation Details

<a
  href="/src/stories/assets/powerbi-theme-structure.png"
  target="_blank"
  rel="noopener noreferrer"
>
  <img
    src="/src/stories/assets/powerbi-theme-structure.png"
