...
<Meta title="Third Party Charts/Boxplot & Violin Plot/📘 Documentation" />
...
- [Box and Whiskers Config Options](https://github.com/sgratzl/chartjs-chart-boxplot/blob/main/src/elements/boxandwhiskers.ts)
