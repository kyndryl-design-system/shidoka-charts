...
.datasets=${[
  {
    ...
    // Box styling options
    width: 0.5,         // Width of the box as a factor (0-1)
    showBox: true,      // Whether to show the box (should be true for boxplots)
    boxWidth: 1,        // Width of the box as a factor (0-1), relevant when used in violin plots

    // Points styling
    points: 100,        // Number of points used for smoother rendering
...
const BoxplotDemo = () => {
  return html`
    <kd-chart
      chartTitle="Example Boxplor Chart"
      description="Performance Metrics for On-Prem Data Center A"
      type="boxplot"
      .labels=${['Q1', 'Q2', 'Q3', 'Q4']}
      .datasets=${[
        {
      ...
      .options=${{
        ...
        plugins: {
          title: {
            display: true,
            text: 'Example Boxplot Chart',
          },
          subtitle: {
            display: true,
            text: 'Performance Metrics for On-Prem Data Center A',
          },
        },
      }}
    ></kd-chart>
